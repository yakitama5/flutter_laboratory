...
final class ColorContrastApp extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return MaterialApp(home: const ColorContrastPage(), theme: theme);
  }
}
...
class ColorContrastPage extends HookWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('色のコントラスト')),
      body: Center(
        child: Column(
          children: [
